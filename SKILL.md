...
3. ✅ **史料原文短引 + 现代汉语释义**（人物、事件、制度等历史问答都必须有）⭐
...
- **摘录原文短引**：每个关键结论至少保留一条可核验短引，优先正史或编年史；短引后立刻写出处和释义。
...
3. **史料原文短引**（必须含书名+章节名、短引、释义；人物/事件回答不得省略）⭐
...
8. **古地名今地说明**（如出现古地名，必须在正文首次出现处自然括注现代行政区划；有歧义或查不到时简短说明）⭐
9. **分析解释**（**仅基于查询到的事实**）
...
- 《[正史名称]》卷XX《[传记/纪名]》：“[原文短引1]”
  释义：[这条短引证明什么事实]
- 《[编年史/其他史料]》卷XX《[章节名]》：“[原文短引2]”
  释义：[这条短引证明什么事实]
