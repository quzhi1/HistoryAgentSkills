...
description: 随机提供一个有趣、短小、经史料核验的中国古代历史段子。适合用户说“来个历史段子”“随机历史小故事”“random-history-anecdote”等请求；按译文、出处、出处考证、职官表、原文的顺序输出，译文直接给正文不写“译文：”，出处考证把辞典解释与我的评价分开，保持简短。不附识典古籍链接和左图右史地图链接，但仍按项目规则换算年号、标注古地名今地，遇官职/爵位/官阶时结合朝代据辞典解释，查不到就重抽或明说。
---
...
“出处考证”一行必须让读者一眼看出哪句是辞典说的、哪句是你的判断；辞典未收该书时写“辞典解释——辞典未收此书”。“职官表”只在段子真出现官职/爵位/官阶时才出现，没有就整段不写；释义要结合段子朝代取义，不照搬别的朝代含义。
