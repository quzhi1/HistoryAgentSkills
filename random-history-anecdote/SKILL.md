...
description: 随机提供一个有趣、短小、经史料核验的中国古代历史段子。适合用户说“来个历史段子”“随机历史小故事”“random-history-anecdote”等请求；输出原文、译文、出处和一句出处可信度评价（辞典解释与我的评价分开），保持简短。不附识典古籍链接和左图右史地图链接，但仍按项目规则换算年号、标注古地名今地，遇官职/爵位/官阶时结合朝代据辞典解释，查不到就重抽或明说。
---
...
5. 查**出处那本书**，评估可信度。用《中国历史大辞典》查这次引用的书名，据词条了解成书年代、作者、性质（正史 / 笔记 / 类书 / 小说等），再据此对这条史料的可信度作一句简短评价。
...
原文：「[一段短引]」
出处：《[书名]》卷/篇《[章节名]》
可信度：辞典解释——[辞典对该书的定性，如成书年代、作者、性质]；我的评价——[一句话可信度判断]。

译文：[只翻译原文；涉及古地名时首次出现括注今地；涉及年号时保留年号并括注公元年。]

职官注（仅在段子里出现官职/爵位/官阶时才写，逐一列出；否则整段省略）：
- [头衔名]（[朝代]）——[据辞典对应义项的一句话释义；辞典未收则写"辞典未收此职官"]。
```

“可信度”一行必须让读者一眼看出哪句是辞典说的、哪句是你的判断；辞典未收该书时写“辞典解释——辞典未收此书”。“职官注”只在段子真出现官职/爵位/官阶时才出现，没有就整段不写；释义要结合段子朝代取义，不照搬别的朝代含义。
...
- [ ] 是否查到了原文，而不是凭记忆复述？
- [ ] 出处是否包含书名 + 卷/篇/章节名？
- [ ] 是否查了出处那本书，并给出可信度评价？辞典解释与我的评价是否分开、没有混为一谈？
- [ ] 译文是否只翻译原文，没有把分析塞进译文？
- [ ] 年号是否已换算；无年号则跳过？
- [ ] 古地名是否已查今地；无古地名则跳过？
